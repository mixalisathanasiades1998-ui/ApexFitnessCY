...
export const en = {
  ...
  auth: {
    ...
    forgotSentBody: "Check your inbox.",
    forgotSentNote:
      "If an account exists for that email, a reset link is on its way. It works for 60 minutes. Do check your spam folder if it does not arrive.",
    forgotTooMany:
    ...
    resetBody: "Enter a new password for your account.",
    resetDeadBody: "This reset link is no longer valid.",
    resetDoneBody: "Your password has been changed.",
    resetNew: "New password",
    resetConfirm: "Confirm new password",
    resetDo: "Save new password",
    resetDoneNote: "You can now sign in with your new password.",
    resetMismatch: "The two passwords do not match.",
    resetExpired: "This link has expired. Reset links work for 60 minutes.",
    resetUsed: "This link has already been used.",
...
export const el: typeof en = {
  ...
  home: {
    ...
    technogym: {
      ...
      body: "Το APEX είναι επίσημος συνεργάτης της Technogym. Οι reformers μας είναι Technogym Reform, και οι χώροι δύναμης και cardio του APEX Fitness Centre είναι πλήρως εξοπλισμένοι με Technogym. Αυτό σημαίνει βαθμονομημένη αντίσταση, σωστή εμβιομηχανική ευθυγράμμιση και εξοπλισμό που αισθάνεσαι ίδιο στο πρώτο και στο εκατοστό μάθημα.",
      points: [
  ...
  auth: {
    ...
    forgotBody:
      "Γράψε το email σου και θα σου στείλουμε σύνδεσμο για να επιλέξεις νέο κωδικό.",
    forgotSend: "Αποστολή συνδέσμου",
    forgotSentBody: "Έλεγξε τα εισερχόμενά σου.",
    forgotSentNote:
      "Αν υπάρχει λογαριασμός για αυτό το email, ο σύνδεσμος επαναφοράς είναι καθ' οδόν. Ισχύει για 60 λεπτά. Έλεγξε και τον φάκελο ανεπιθύμητων αν δεν φτάσει.",
    forgotTooMany:
      "Πολλές αιτήσεις αυτή τη στιγμή. Περίμενε λίγα λεπτά και δοκίμασε ξανά.",
    backToSignIn: "Πίσω στη σύνδεση",
    showPassword: "Εμφάνιση κωδικού",
    hidePassword: "Απόκρυψη κωδικού",
    resetTitle: "Επίλεξε νέο κωδικό",
    resetBody: "Γράψε έναν νέο κωδικό για τον λογαριασμό σου.",
    resetDeadBody: "Αυτός ο σύνδεσμος επαναφοράς δεν ισχύει πλέον.",
    resetDoneBody: "Ο κωδικός σου άλλαξε.",
    resetNew: "Νέος κωδικός",
    resetConfirm: "Επιβεβαίωση νέου κωδικού",
    resetDo: "Αποθήκευση νέου κωδικού",
    resetDoneNote: "Μπορείς τώρα να συνδεθείς με τον νέο σου κωδικό.",
    resetMismatch: "Οι δύο κωδικοί δεν ταιριάζουν.",
    resetExpired: "Ο σύνδεσμος έληξε. Οι σύνδεσμοι επαναφοράς ισχύουν για 60 λεπτά.",
    resetUsed: "Αυτός ο σύνδεσμος έχει ήδη χρησιμοποιηθεί.",
    resetInvalid: "Αυτός ο σύνδεσμος επαναφοράς δεν είναι έγκυρος.",
    resetAskAgain: "Ζήτησε νέο σύνδεσμο",
  },
  account: {
    greeting: "Γεια σου",
  ...
  footer: {
    ...
    partner: "Επίσημος συνεργάτης της Technogym",
