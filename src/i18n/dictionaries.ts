...
export const en = {
  ...
  desk: {
    ...
    priceNow: "now",
    /* Pricing tab: the three sections and their forms. */
    packsSectionTitle: "Packs",
    promoSectionTitle: "Promo codes",
    offersSectionTitle: "Offers",
    packsManageHelp:
      "Edit what the studio sells and for how much. A pack you have sold cannot be deleted, only taken off sale, so members' history and invoices stay intact.",
    packNew: "New pack",
    packEdit: "Edit",
    packNameEn: "Name (English)",
    packNameEl: "Name (Greek)",
    packHeading: "Heading on the pricing page",
    packSessions: "Sessions",
    packDaysField: "Valid for (days)",
    packPriceField: "Price (€)",
    packSave: "Save",
    packCancel: "Cancel",
    packSaved: "Pack saved.",
    packCreated: "Pack created.",
    packBad: "Please check the pack details.",
    packNeedName: "Give the pack a name.",
    packNeedSessions: "Sessions must be a whole number from 1 to 500.",
    packNeedDays: "Valid for must be a whole number of days from 1 to 1095.",
    packNeedPrice: "The price must be at least €1.",
    packForbidden:
      "Only the owner can change packs. Unlock the console as the owner and try again.",
    packOff: "Off sale",
    ...
    packSold:
      "This pack has been sold, so it cannot be deleted. Members' history points at it. Take it off sale instead.",
    packGroups: {
      ...
      half: "Six months",
      nine: "Nine months",
      personal: "Personal & Duet",
    },
    promoHelp:
      "A code a member types at checkout. Scope it to one pack or the whole list, set when it runs, and cap how many times it can be used.",
    promoCode: "Code",
    promoKind: "Discount",
    ...
    promoWholeList: "The whole list",
    promoFrom: "Valid from",
    promoUntil: "Valid until",
    promoMax: "Maximum uses",
    promoNoLimit: "No limit",
    promoCreate: "Create code",
    promoCreated: "Code created.",
    promoTaken: "That code already exists.",
    promoBad: "Please check the code details.",
    promoNone: "No codes yet.",
    promoUses: "uses",
    promoDelete: "Delete",
    promoStates: {
      LIVE: "Live",
    ...
    teamTitle: "Team",
    teamHelp:
      "The instructors shown on the studio page. Nobody is deleted: hide someone to take them off the page while keeping their name on past classes.",
    teamAdd: "Add instructor",
    teamEdit: "Edit",
    teamName: "Name",
    teamPhoto: "Portrait address",
    teamPhotoHelp:
      "A path on the site starting with / (for a shipped portrait) or a full https:// address. Leave empty for the studio mark.",
    teamBioEn: "Bio (English)",
    teamBioEl: "Bio (Greek)",
    teamBioFallback:
      "Left empty, readers of this language see the English bio.",
    teamHide: "Hide",
    teamRestore: "Restore",
    teamSaved: "Saved.",
  ...
  checkoutPage: {
    ...
    codeApply: "Apply",
    codeRemove: "Remove",
    codeInvalid: "That code is not valid for this pack.",
...
export const el: typeof en = {
  ...
  desk: {
    ...
    priceNow: "τώρα",
    packsSectionTitle: "Πακέτα",
    promoSectionTitle: "Κωδικοί έκπτωσης",
    offersSectionTitle: "Προσφορές",
    packsManageHelp:
      "Άλλαξε τι πουλάει το στούντιο και σε τι τιμή. Ένα πακέτο που έχει πουληθεί δεν διαγράφεται, μόνο αποσύρεται από την πώληση, ώστε το ιστορικό και τα τιμολόγια των μελών να μένουν άθικτα.",
    packNew: "Νέο πακέτο",
    packEdit: "Επεξεργασία",
    packNameEn: "Όνομα (Αγγλικά)",
    packNameEl: "Όνομα (Ελληνικά)",
    packHeading: "Επικεφαλίδα στη σελίδα τιμών",
    packSessions: "Συνεδρίες",
    packDaysField: "Ισχύς (ημέρες)",
    packPriceField: "Τιμή (€)",
    packSave: "Αποθήκευση",
    packCancel: "Άκυρο",
    packSaved: "Το πακέτο αποθηκεύτηκε.",
    packCreated: "Το πακέτο δημιουργήθηκε.",
    packBad: "Έλεγξε τα στοιχεία του πακέτου.",
    packNeedName: "Δώσε όνομα στο πακέτο.",
    packNeedSessions: "Οι συνεδρίες πρέπει να είναι ακέραιος από 1 έως 500.",
    packNeedDays: "Η ισχύς πρέπει να είναι ακέραιος αριθμός ημερών από 1 έως 1095.",
    packNeedPrice: "Η τιμή πρέπει να είναι τουλάχιστον €1.",
    packForbidden:
      "Μόνο ο ιδιοκτήτης μπορεί να αλλάξει πακέτα. Ξεκλείδωσε την κονσόλα ως ιδιοκτήτης και δοκίμασε ξανά.",
    packOff: "Εκτός πώλησης",
    packSwitchOff: "Απόσυρση από πώληση",
    packSwitchOn: "Επαναφορά σε πώληση",
    packDelete: "Διαγραφή",
    packDeleteConfirm: "Πάτησε ξανά για διαγραφή",
    packDeleted: "Το πακέτο διαγράφηκε.",
    packSold:
      "Αυτό το πακέτο έχει πουληθεί, οπότε δεν διαγράφεται. Το ιστορικό των μελών δείχνει σε αυτό. Απόσυρέ το από την πώληση.",
    packGroups: {
      single: "Μία τη φορά",
      month: "Μηνιαία",
      quarter: "Τρεις μήνες",
      half: "Έξι μήνες",
      nine: "Εννέα μήνες",
      personal: "Ατομικές & Δυάδες",
    },
    promoHelp:
      "Ένας κωδικός που πληκτρολογεί το μέλος στην πληρωμή. Όρισέ τον σε ένα πακέτο ή σε όλη τη λίστα, πότε ισχύει, και πόσες φορές μπορεί να χρησιμοποιηθεί.",
    promoCode: "Κωδικός",
    promoKind: "Έκπτωση",
    promoPercent: "Ποσοστό",
    promoEuro: "Ευρώ",
    promoAmount: "Ποσό",
    promoApplies: "Ισχύει για",
    promoWholeList: "Όλη τη λίστα",
    promoFrom: "Ισχύει από",
    promoUntil: "Ισχύει έως",
    promoMax: "Μέγιστες χρήσεις",
    promoNoLimit: "Χωρίς όριο",
    promoCreate: "Δημιουργία κωδικού",
    promoCreated: "Ο κωδικός δημιουργήθηκε.",
    promoTaken: "Αυτός ο κωδικός υπάρχει ήδη.",
    promoBad: "Έλεγξε τα στοιχεία του κωδικού.",
    promoNone: "Κανένας κωδικός ακόμη.",
    promoUses: "χρήσεις",
    promoDelete: "Διαγραφή",
    promoStates: {
      LIVE: "Ενεργός",
      OFF: "Ανενεργός",
    ...
    teamTitle: "Ομάδα",
    teamHelp:
      "Οι εκπαιδευτές που εμφανίζονται στη σελίδα του στούντιο. Κανείς δεν διαγράφεται: κρύψε κάποιον για να τον αφαιρέσεις από τη σελίδα κρατώντας το όνομά του στα προηγούμενα μαθήματα.",
    teamAdd: "Προσθήκη εκπαιδευτή",
    teamEdit: "Επεξεργασία",
    teamName: "Όνομα",
    teamPhoto: "Διεύθυνση φωτογραφίας",
    teamPhotoHelp:
      "Μια διαδρομή στον ιστότοπο που ξεκινά με / ή μια πλήρης διεύθυνση https://. Άφησέ το κενό για το σήμα του στούντιο.",
    teamBioEn: "Βιογραφικό (Αγγλικά)",
    teamBioEl: "Βιογραφικό (Ελληνικά)",
    teamBioFallback:
      "Αν μείνει κενό, οι αναγνώστες αυτής της γλώσσας βλέπουν το αγγλικό βιογραφικό.",
    teamHide: "Απόκρυψη",
    teamRestore: "Επαναφορά",
    teamSaved: "Αποθηκεύτηκε.",
  ...
  auth: {
    ...
    confirmPasswordRegister: "Επιβεβαίωση κωδικού",
    errMismatch: "Οι δύο κωδικοί δεν ταιριάζουν.",
  ...
  checkoutPage: {
    ...
    codeLabel: "Κωδικός έκπτωσης",
    codeApply: "Εφαρμογή",
    codeRemove: "Αφαίρεση",
    codeInvalid: "Ο κωδικός δεν ισχύει για αυτό το πακέτο.",
